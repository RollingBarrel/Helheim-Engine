...
bool ModuleSkybox::Init()
{
    ...
    unsigned vtx_shader = CompileShader(GL_VERTEX_SHADER, ReadShader("Assets/Shaders/skybox.vs"));
    unsigned frg_shader = CompileShader(GL_FRAGMENT_SHADER, ReadShader("Assets/Shaders/skybox.fs"));
